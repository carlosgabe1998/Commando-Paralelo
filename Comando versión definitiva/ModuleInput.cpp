...
update_status ModuleInput::PreUpdate()
{
	...
	if (keyboard[SDL_SCANCODE_F5] == KEY_STATE::KEY_DOWN && keyboard[SDL_SCANCODE_LALT] == KEY_STATE::KEY_IDLE && !App->player->godmode)
	{
		App->player->godmode = true;
	}
	else if (keyboard[SDL_SCANCODE_F5] == KEY_STATE::KEY_DOWN && keyboard[SDL_SCANCODE_LALT] == KEY_STATE::KEY_IDLE && App->player->godmode)
	{
