...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_PLAYER_GRENADE][COLLIDER_POWERUP] = false;
	...
	matrix[COLLIDER_DOWNSTAIRS][COLLIDER_POWERUP] = false;
	...
	matrix[COLLIDER_UPSTAIRS][COLLIDER_POWERUP] = false;
	...
	matrix[COLLIDER_WATER][COLLIDER_POWERUP] = false;
	...
	matrix[COLLIDER_ANTIBULLET][COLLIDER_POWERUP] = false;
	...
	matrix[COLLIDER_POWERUP][COLLIDER_PLAYER_GRENADE] = false;
